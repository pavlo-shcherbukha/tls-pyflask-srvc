...
set fltempl=pyedge-ubi8docker-srvc-templ.yaml
set fldepl=pyedge-ubi8docker-srvc-depl.yaml 
oc delete -f %fldepl%
...
set DOCKER_PTH=./openshift-tls-edge/ubi8_docker_deployment/Dockerfile
