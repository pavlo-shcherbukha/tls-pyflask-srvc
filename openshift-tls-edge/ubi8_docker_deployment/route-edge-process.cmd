...
set fltempl=pyedge-ubi8docker-route-temp.yaml
set fldepl=pyedge-ubi8docker-route-depl.yaml
...
set APP_NAME=py-tls
set ROUTENAME=pyedge-ubi8docker-srvc-%APP_PROJ%.%APP_DNS%
set SRVHOSTNAME=pyedge-1ubi8docker-srvc-%APP_PROJ%.%APP_DNS%
set PORTNUMBER=8080
